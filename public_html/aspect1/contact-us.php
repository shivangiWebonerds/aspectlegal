<?php include 'header.php' ?>
	...
	<div id="content-wrapper">
		<div class="blocks-container">		
			...
			<!-- BLOCK "TYPE 3" -->		
			<div class="block type-3 background-block" style="background-image: url(&quot;img/background-7.jpg&quot;);">
				<img class="center-image" src="img/background-7.jpg" alt="" style="display: none;">
				<div class="container">
					<div class="row">
